  ...
  return (
    <section id="aboutme">
      <div className="aboutme--container">
        <p>
          Hello, my name is Michaela and I am a junior front-end developer. I
          have been working on my education in the IT field for a while already
          and now, I am ready and open to find a job as a junior frontend
          developer. I would like to use my achieved skills and further develop
          myself, my abilities and be part of a supportive and friendly team.
        </p>
